...
function QuestionContainer(props) {
  ...
  useEffect((props) => {
    async function setData() {
      ...
      let url = `https://opentdb.com/api.php?amount=${propsData.amount}&type=multiple?category=${propsData.categoryId}?difficulty=${propsData["questionDifficultyState"]["difficulty"]}`;
