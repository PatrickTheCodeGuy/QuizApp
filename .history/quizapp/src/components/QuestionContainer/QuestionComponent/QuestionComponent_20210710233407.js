...
function QuestionComponent(props) {
    ...
    let [ answers, setAnswers ] = useState(shuffleArray([...replaceSpecialStrArray(props.incorrect), replaceSpecialCode(props.answer)]));
    ...
    useEffect(() => {
        ...
        setAnswers(shuffleArray([...replaceSpecialStrArray(props.incorrect), replaceSpecialCode(props.answer)]));
    }, [props])
