...
function QuestionComponent(props) {
    ...
    const onClick = useCallback((answer) => {
        ...
        setTimeout(() => {
            console.log("before: ",props.answeredCorrectly)
            props.answeredCorrectly = !props.answeredCorrectly
            console.log("after: ", props.answeredCorrectly)
            props.setAnsweredCorrectly(props.answeredCorrectly);
        }, 5000)
