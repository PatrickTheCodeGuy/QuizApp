...
function replaceSpecialString(question) {
    let scrubbedString = replaceSpecialCharacters(question)
    console.log("scrubbed string: ", scrubbedString)
    
}

function replaceSpecialStrArray(strArray) {
    let scrubbedArray = replaceSpecialCharacters(strArray)
...
function QuestionComponent(props) {
    ...
    let [ answers, setAnswers ] = useState(shuffleArray([...replaceSpecialStrArray(props.incorrect), replaceSpecialString(props.answer)]));
    ...
    useEffect(() => {
        ...
        setAnswers(shuffleArray([...replaceSpecialStrArray(props.incorrect), replaceSpecialString(props.answer)]));
    }, [props])
