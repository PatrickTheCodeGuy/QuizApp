...
function QuestionComponent(props) {
    ...
    let [ answers, setAnswers ] = useState(shuffleArray(replaceSpecialStrArray([...props.incorrect, props.answer])));
    ...
    useEffect(() => {
        ...
        setAnswers(shuffleArray(replaceSpecialStrArray([...props.incorrect, props.answer])));
    }, [props])
