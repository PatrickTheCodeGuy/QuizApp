export function replaceSpecialCharacters(questionStr)  {
    ...
    list.forEach((specialChar, index) => {
        ...
        console.log("specialChar at index: ", specialChar[keysArray[index]]);
        questionStr = questionStr.replace(specialChar[keysArray[index]], keysArray[index]);
    })
