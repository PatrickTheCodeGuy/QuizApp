...
function QuestionContainer(props) {
  ...
  useEffect((props) => {
    async function setData() {
      ...
      let url = `https://opentdb.com/api.php?amount=${propsData["questionNum"]}&type=multiple?category=${propsData["categoriesId"]}?difficulty=${propsData["questionDifficultyState"]["difficulty"]}`;
