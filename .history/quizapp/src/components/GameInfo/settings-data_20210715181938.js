export const timerOptions = [
  ...
  {
    label: "8 seconds (1.25x)",
    value: { type: "Time", time: 8, multiplier: 2.15 },
  },
  {
    label: "5 seconds (1.5x)",
    value: { type: "Time", time: 5, multiplier: 2.5 },
  },
  {
    label: "4 seconds (1.75x)",
    value: { type: "Time", time: 4, multiplier: 3.2 },
  },
];
...
export const questionDifficulty = [
  ...
  {
    label: "Medium (1.25x)",
    value: { type: "Difficulty", difficulty: "Medium", multiplier: 1.15 },
  },
  {
    label: "Hard (1.5x)",
