    ...
    return(
        <div className="gameInfo-container">
            ...
            <div className="gameInfo-body">
												...
												<div>
													<p class="regular-text">Welcome to Quizania! The rules are simple: Answer the question in the alloted time. If you select the correct answer you get points! Try to get as many as you can until you cant anymore.</p>
