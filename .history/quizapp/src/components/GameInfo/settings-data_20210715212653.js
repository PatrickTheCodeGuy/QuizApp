export const timerOptions = [
  {
    ...
    value: { type: "Time", time: 10, multiplier: 1 },
  },
  {
    key: 1,
  ...
  {
    key: 2,
    label: "6 seconds (3.8x)",
    value: { type: "Time", time: 6, multiplier: 3.8 },
  },
  {
    key: 3,
...
export const questionDifficulty = [
  {
    key: 0,
    label: "Random (1.0x)",
    value: { type: "Difficulty", difficulty: "", multiplier: 1 },
  },
  {
    key: 1,
    label: "Easy (0.5x)",
  ...
  },
  {
    key: 2,
    label: "Medium (1.2x)",
    value: { type: "Difficulty", difficulty: "medium", multiplier: 1.2 },
  },
  {
    key: 3,
    label: "Hard (2.0x)",
    value: { type: "Difficulty", difficulty: "hard", multiplier: 2.0 },
  },
];
